...
// Block __proto__ setter to prevent prototype pollution
...
if (protoDescriptor && protoDescriptor.set) {
	localObject.defineProperty(localObject.prototype, '__proto__', {
...
// Block Reflect.setPrototypeOf
localObject.defineProperty(localReflect, 'setPrototypeOf', {
	value: () => {
		throw new VMError('Operation not allowed on contextified object.');
	}
});
