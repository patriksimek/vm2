...
Decontextify.instance = (instance, klass, deepTraps, flags, toStringTag) => {
	...
	base.get = (target, key, receiver) => {
		...
		// node v14.6 or above will provide a safer inspect for cross-context objects
		// https://github.com/nodejs/node/commit/e0206bafe6
		if (key === host.inspect.custom && !(key in instance) && host.NODE_MAJOR >= 14 && host.NODE_MINOR >= 6) {
