...
const FROZEN_TRAPS = Object.create(null);
...
const Decontextify = Object.create(null);
...
Decontextify.instance = (instance, klass, deepTraps, flags) => {
	// We must not use normal object because there's a chance is already contains malicious code in the prototype
...
const Contextify = Object.create(null);
