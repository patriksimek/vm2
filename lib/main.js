...
class VMScript {
	...
	compile() {
		...
		if (this.options.lineOffset !== undefined) {
			scriptOptions.lineOffset = this.options.lineOffset;
		}
		if (this.options.columnOffset !== undefined) {
			scriptOptions.columnOffset = this.options.columnOffset;
		}
		this._compiled = new vm.Script(this.code, scriptOptions);
