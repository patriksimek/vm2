	...
	value: function(value, traps, deepTraps, flags, mock) {
		...
		switch (typeof value) {
			case 'object':
				...
				} else if (value instanceof EvalError)      { return Decontextify.instance(value, host.EvalError, deepTraps, flags);
				...
				} else if (value instanceof URIError)       { return Decontextify.instance(value, host.URIError, deepTraps, flags);
	...
	value: function(value, traps, deepTraps, flags, mock) {
		...
		switch (typeof value) {
			case 'object':
				...
				} else if (value instanceof host.EvalError)      { return Contextify.instance(value, EvalError, deepTraps, flags);
				...
				} else if (value instanceof host.URIError)       { return Contextify.instance(value, URIError, deepTraps, flags);
