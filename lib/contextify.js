...
function fakeDefineGetter(receiver, useLocalDefiner) {
	return function __defineGetter__(key, value) {
		(useLocalDefiner ? Object : host.Object).defineProperty(receiver, key, {get: value, enumerable: true, configurable: true});
	}
}

function fakeDefineSetter(receiver, useLocalDefiner) {
	return function __defineSetter__(key, value) {
		(useLocalDefiner ? Object : host.Object).defineProperty(receiver, key, {set: value, enumerable: true, configurable: true});
	}
}
