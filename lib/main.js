...
class VMScript {
	 ...
	 * @throws {TypeError} If code is a Symbol.
	...
	constructor(code, options) {
		...
		// Throw if the compiler is unkown.
...
class VM extends EventEmitter {
	 ...
	 * @throws If the compiler is unknown.
	 */
	constructor(options = {}) {
		super();
	 ...
	 * @return {*} Result of executed code.
	 * @throws This will throw when there is a syntax error in the script.
	 * @throws This will throw when the script took to long and there is a timeout.
