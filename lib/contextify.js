	...
	try {
		...
		switch (typeof value) {
			case 'object':
				...
				} else if (typeof Promise === 'function' && instanceOf(value, Promise)) { return Decontextify.instance(value, host.Promise, deepTraps, flags, 'Promise');
	...
	try {
		...
		switch (typeof value) {
			case 'object':
				...
				} else if (typeof Promise === 'function' && instanceOf(value, host.Promise)) { return Contextify.instance(value, Promise, deepTraps, flags, 'Promise');
