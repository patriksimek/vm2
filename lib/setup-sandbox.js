...
const blockedSymbols = {
	'nodejs.util.inspect.custom': Symbol('nodejs.util.inspect.custom'),
	'nodejs.rejection': Symbol('nodejs.rejection')
};
Symbol.for = function(key) {
	if (Object.prototype.hasOwnProperty.call(blockedSymbols, key)) {
		return blockedSymbols[key];
	}
